...
class GTMaskDataset(Dataset):
    def __init__(self, dataset_folder, transform, resolution=512):
        self.env = lmdb.open(
        ...
        # CelebA_HQ_to_CelebA = (
        #     f"{dataset_folder}/local_editing/new_mapping.txt"
        # )
        ...
        # original_test_path = f"{dataset_folder}/test/src/1"
        mask_label_path = f"{dataset_folder}/test/mask"
