...
class Decoder(nn.Module):
    ...
    def forward(self, style_code, mix_space=None, mask=None):
        ...
        # elif mix_space == "demo":
        elif mix_space == "demo" or mix_space == "demo1":
        ...
        if mix_space == None:
        ...
        elif mix_space == "demo1":  # mix stylemaps in W+ space using masks
            mask1, mask2, interpolation_step = mask
            ...
            for up_layer in self.convs_latent:
                ...
                ratio = self.size // H
                masks = nn.AvgPool2d(kernel_size=ratio, stride=ratio)(mask1)
                mask_moved = nn.AvgPool2d(kernel_size=ratio, stride=ratio)(mask2)
                ...
                print("--------------")
                print(reference_stylemaps.shape)
                print(original_stylemap_all.shape)
                print(len(reference_stylemaps))
            ...
            # image_masks: class Tensor, size([1, 1, 256, 256])
            # shift_values: class list,[[0, 0, 0], [0, 0, 0]]
            # print("--------------------")
            # print(type(image_masks))
            # print(image_masks)
            # print(image_masks.shape)
            # print(type(shift_values))
            # print(shift_values)
            original_stylemap = style_code[0]
            reference_stylemaps = style_code[1]
            style_codes = []
