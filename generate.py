        ...
        if args.mixing_type == "random_generation":
            ...
            for loop_i, (index1, index2) in tqdm(
                ...
                if args.mixing_type == "w_interpolation":
                    ...
                    '''
                    mask.size: 16*256*256
                    mask1_logit.shape: 256*256
                    ...
                    if dataset_name == "celeba_hq":
                        ...
                        # aaa = -torch.ones(mask1_logit.shape).to(device)
                        # aaa[(mask1_logit == 2) == True] = 1
                        # aaa = aaa.float()
                        # save_images(
                        #     [aaa],
                        #     [
                        #         f"{args.save_image_dir}/aaa/{index1}.png",
                        #     ],
                        # )
                        # print(index1)
                        # temp = masks[index1]
                        ...
                        # temp /= 255
                        # temp = transforms.ToPILImage()(temp)
                        # temp.save(str(index1) + ".png")
                        #
                        # temp2 = real_imgs[index1]
                        #
                        # temp2 = temp2.cpu().float()
                        # temp2 /= 255
                        # temp2 = transforms.ToPILImage()(temp2)
                        # temp2.save(str(index1) + "a.png")
