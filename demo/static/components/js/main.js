...
function updateResult() {
    ...
    selected_region = $("#region-picker").val();

    $.ajax({
        type: "POST",
        url: "/post",
        data: JSON.stringify({ "id": id, "original": original_image, "references": palette, "data_reference": data_reference, "shift_original": [p5_input_original.r_x, p5_input_original.r_y], "colors": colors , "region": selected_region}),
        dataType: "json",
